...
* Some attacks other than fully-charged bow CAs can stun ruin guards. This includes various skills, bursts and melee attacks. The list is [here](...evidence/combat-mechanics/enemy-mechanics/enemy-interactions.md#melee-can-stun-ruin-guard)
