...
**Finding:** When anemo abilities with elemental absorption check self aura on the active characters, it inflicts 0 damage to them. This can trigger some passives that activate on hit. However, they will stop hitting allies after absorbing any element.
