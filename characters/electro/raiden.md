...
| :--- | :--- |
| Skill DMG | 164.08% |
| Coordinated ATK DMG | 58.8% |
| Elemental Burst DMG Bonus | 0.27% Per Energy |
| Particles | 0~1 (1:1) |
| Frames | 35 |
| GU initial cast | 2B
| GU coordinated atk | 1A |
...
| Effect | Initial Slash (Talent 6%) | Basic Attacks (Talent 6%) |
| :--- | :--- | :--- |
| Musou no Hitotachi Base Slash DMG | 561.12% | -- |
| Resolve Bonus | 5.44% ATK DMG Per Stack | 1.02% ATK DMG Per Stack |
| Resolve Stacks Gained | 0.18 Per Energy Consumed | 0.18 Per Energy Consumed |
